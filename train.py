...
def train_agent(train_data, n_episodes=NUM_EPISODES, 
                n_bins=NUM_BINS):
...
def cross_validate(data, n_bins=NUM_BINS, 
...
if __name__ == "__main__":
    ...
    # Train agent
    agent, training_stats = train_agent(train_data)
    
    # Plot training statistics
    plot_training_stats(training_stats, save_path=f'training_stats.png')
    
    # Save agent
    agent.save(f'agent.npy')
